...
//  Copyright © 2018年 Adonis Gaitatzis. All rights reserved.
//
...
class WaveformView: UIView {
    ...
    var signal1Data: [CGFloat] = Array(repeating: CGFloat(UINT16_MAX/2), count: 1000) {
        didSet {
            setNeedsDisplay()
        }
    }
    ...
    var signal2Data: [CGFloat] = Array(repeating: CGFloat(UINT16_MAX/2), count: 1000) {
        didSet {
            setNeedsDisplay()
        }
    }
